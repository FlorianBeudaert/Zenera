          ...
          <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
              ...
              <div className="max-w-4xl mx-auto text-center relative">
                  <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
                      Bienvenue sur le
                      <span
                          className="block text-transparent bg-gradient-to-r from-primary via-secondary to-primary-hover bg-clip-text">
                          Zanera Wiki
                      </span>
                  </h1>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <a className="bg-white text-gray-900 font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-shadow flex items-center justify-center"
                         href="/wiki">
                          <Book className="w-5 h-5 mr-2"/>
                          Explorer le wiki
                      </a>
                      <a className="bg-gradient-to-r from-primary to-primary-hover text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-shadow flex items-center justify-center"
                         href="#">
          ...
          <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary/10 to-primary-hover/20">
              <div className="max-w-3xl mx-auto text-center">
                  ...
                  <ul className="text-left mb-8 mx-auto max-w-md space-y-3">
                    ...
                    <a className="bg-gradient-to-r from-primary to-primary-hover text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-shadow inline-flex items-center"
                         href="#">
