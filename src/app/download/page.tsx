...
const downloads = [
	{
		...
		link: 'https://github.com/FlorianBeudaert/Sianox-Launcher/releases/download/1.0.1/Sianox-Launcher-win-x64.exe',
		bg: 'from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300',
	},
	{
		name: 'Mac',
		icon: <FaApple size={48} color="#333" />,
		link: 'https://github.com/FlorianBeudaert/Sianox-Launcher/releases/download/1.0.1/Sianox-Launcher-mac-universal.dmg',
		bg: 'from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300',
	},
	{
		name: 'Linux',
		icon: <FaLinux size={48} color="#222" />,
		link: 'https://github.com/FlorianBeudaert/Sianox-Launcher/releases/download/1.0.1/Sianox-Launcher-linux-x86_64.AppImage',
