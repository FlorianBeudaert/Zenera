...
export const weapons: Item[] = [
	...
	{
		name: 'Dragonblade',
		description: 'Épée légendaire post-Dragon, infligeant de lourds dégâts et capable d’asséner un puissant coup de poing après 3 attaques. Le coup projette violemment l’ennemi, perce l’armure et l’étourdit brièvement. Un seul exemplaire apparaît, planté dans l’Autel des Maudits après la première défaite de l’Ender Dragon.',
		bonus: 'Coup de poing dévastateur après 3 attaques, 40% pénétration d’armure, étourdit et affaiblit la cible, dégâts accrus contre les murs.',
